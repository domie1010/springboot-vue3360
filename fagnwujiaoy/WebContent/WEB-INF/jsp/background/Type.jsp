                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="sys/type/typeUpdate" method="post" onsubmit="return check();">
                                            <input type="hidden" value="${type['id'] }" name="id">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">类别名称：</td>
                                                        <td width="25%"><input class="text" type="text" name="typeName" id="typeName" value="${type['typeName'] }" /></td>
                                                        <td>设置产品名称</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                </table>
