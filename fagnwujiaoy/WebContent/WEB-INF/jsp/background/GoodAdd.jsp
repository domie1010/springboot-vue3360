                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="sys/good/goodAdd" method="post" onsubmit="return check();" enctype="multipart/form-data">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">房屋名称：</td>
                                                        <td width="25%"><input class="text" type="text" name="goodName" id="goodName"  /></td>
                                                        <td>设置房屋名称</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>房屋价格：</td>
                                                        <td width="20%"><input class="text" onkeyup="value=value.replace(/[^\d]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" style="width:100px;" type="text" name="goodPrice" id="goodPrice" /></td>
                                                        <td>填写房屋价格</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>房屋大小：</td>
                                                        <td width="20%"><input class="text" onkeyup="value=value.replace(/[^\d]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" style="width:100px;" type="text" name="goodType" id="goodType" /></td>
                                                        <td>设置产品大小</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>房屋地址：</td>
                                                        <td><textarea name="goodIntroduce" id="goodIntroduce"></textarea></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
