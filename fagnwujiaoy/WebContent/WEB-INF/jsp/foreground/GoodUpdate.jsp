...
<form id="jobform" method="post" action="sys/good/goodUpdateF" name="jobform" enctype="multipart/form-data">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">房屋名称：</td>
      <td> 
        <input type="text" name="goodName" id="goodName" value="${good['goodName'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

    <tr> 
      <td width="80" align="right">房屋价格：</td>
      <td> 
        <input type="text" name="goodPrice" id="goodPrice" value="${good['goodPrice'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>


	<tr> 
      <td width="80" align="right">房屋大小：</td>
      <td> 
        <input type="text" name="goodType" id="goodType" value="${good['goodType'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

    <tr> 
      <td width="80" align="right">房屋地址：</td>
      <td> 
        <input type="text" name="goodIntroduce" id="goodIntroduce" value="${good['goodIntroduce'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
    ...
    <tr> 
      ...
      <td height="30">
        ...
        <input type='hidden' name='goodLord' value="${sessionScope['User']['account'] }">
