...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  <tr >
			...
			<td class="cap">房屋价格</td>
			<td class="cap">房屋大小</td>
			<td class="cap">房屋地址</td>
			<td class="cap">房东姓名</td>
			<td class="cap">状态</td>
		  </tr>
		  <c:forEach items="${pager.datas }" var="bargain" varStatus="vs">
                <tr >
	                <td>&nbsp; </td>
	                <td>${bargain['goodName'] }</td>
	                <td>${bargain['goodPrice'] }</td>
	                <td>${bargain['goodType'] }</td>
	                <td>${bargain['customAddress'] }</td>
	                <td>${bargain['customTel'] }</td>
	                <td>
		                <c:if test="${bargain['status'] eq 1}">
		                	交易中
		                </c:if>
		                <c:if test="${bargain['status'] eq 2}">
		                	交易成功
		                </c:if>
		                <c:if test="${bargain['status'] eq 3}">
		                	交易失败
		                </c:if>
	                </td>
                </tr>
