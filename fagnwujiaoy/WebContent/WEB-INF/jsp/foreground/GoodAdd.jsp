...
<form id="jobform" method="post" action="sys/good/goodAddF" name="jobform" enctype="multipart/form-data" onsubmit="return Check();">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">房屋名称：</td>
      <td> 
        <input type="text" name="goodName" id="goodName" class="input" style="width:200px" />
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="goodPrice" id="goodPrice" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	...
	<tr> 
      ...
      <td> 
        <input type="text" name="goodType" id="goodType" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="goodIntroduce" id="goodIntroduce" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
     <tr> 
      <td width="80" align="right">上传图片：</td>
      <td> 
        <input type="file" name="file" id="file" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
