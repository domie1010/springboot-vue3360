...
<div id="shopcontent">
<form method="post" id="good" action="sys/bargain/add" onsubmit="return check();">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="piczone">
				...
				<td align="center">
				<div id="shopview">
					<img src="upload/upload/${good['url'] }" style="width: 174px;height: 241px;" border="0" id="shoploading" class="shoploading">
				</div>
				</td>
				</tr>
				</table>
		  ...
		  <div id="prodtitle">${good['goodName'] } </div>
			<div id="prop">
				...
				<input type="hidden" name="customName" id="customName" value="${sessionScope['User']['account'] }">
				<input type="hidden" name="customTel" value="${good['goodLord']}">
				<input type="hidden" name="customAddress" value="${good['goodIntroduce']}">
				<input type="hidden" name="status" value="1">
				<input type="hidden" id="status" value="${good['status'] }">
				<input type="hidden" name="houseLord" id="houseLord" value="${good['goodLord'] }">
				<div id="memo" class="memo" style="display:block">${good['goodIntroduce']}</div>
			</div>
			<div style="padding:5px;">
			房屋售价：<span class="price">￥${good['goodPrice'] }</span><br />
			</div>
			
			<div class="buttonzone"> 
				<input type="submit" id="submit" value="我要买房">
	...
	<div id="bodyzone" class="bodyzone"><p><font face=宋体 size=3>
				...
				电话：${good['goodType'] }<br />
				地址：${good['goodType'] }<br />
				介绍：${good['goodType'] }<br /></font></p></div>
