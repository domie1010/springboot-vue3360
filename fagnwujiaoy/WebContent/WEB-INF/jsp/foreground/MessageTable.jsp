...
<div id='pdv_3514' class='pdv_class'  title='商品搜索' style='width:743px;height:26px;top:95px;left:92px; z-index:6'>
<div id='spdv_3514' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
<div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
	<div style="height:25px;margin:1px;display:none;background:;">
		<div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;color:">
		商品搜索
...
<div class="pdv_border" style="margin:0;padding:0;height:100%;border:4px #eeeeee solid;background:#fff;">
	<div style="height:25px;margin:1px;display:block;background:#f0f0f0;">
		...
		<c:if test="${sessionScope['User']['type'] eq 3}">
			<a href="sys/request/messageAdd" style="line-height:25px;color:#505050">添加</a>
		</c:if>
		</div>
	</div>
...
<ul class="bbslist">
	...
	<c:forEach items="${pager.datas }" var="messageI" varStatus="vs">
	<li>${messageI['userMessage'] } &nbsp;&nbsp;发布人:${messageI['goodId'] } &nbsp;&nbsp;<a href="sys/type/query?messageId=${messageI['id'] }">回复</a></li>
	</c:forEach>
</ul>
