...
public class UserServiceImpl implements UserService {
	...
	public Integer queryCount() {
		Integer count = this.userDao.queryCount();
		return count;
	}
	@Override
	public void userAdd(String account, String tel, String address, String password, String type,String email,String safe) {
		try{
			this.userDao.userAdd(account, tel, address, password,type,email,safe);
		}catch (Exception e) {
	...
	public void informationUpdate(Integer id, String account, String tel, String address, String password,
			String type,String email,String safe) {
		try{
			this.userDao.informationUpdate(id, account, tel, address, password,type,email,safe);
		}catch (Exception e) {
	...
	@Override
	public User loginVip(String account, String password, String type, String safe) {
		User user = userDao.loginVip(account, password,type,safe);
		if(user==null){
