...
public class TypeServiceImpl implements TypeService {
	...
	@Override
	public void typeAdd(String typeName,Integer messageId,String name) {
		try{
			this.typeDao.typeAdd(typeName,messageId,name);
		}catch (Exception e) {
	...
	@Override
	public void informationUpdate(Integer id, String typeName,Integer messageId,String name) {
		try{
			this.typeDao.informationUpdate(id, typeName,messageId,name);
		}catch (Exception e) {
	...
	public List<Type> QueryAll() {
		List<Type> list = this.typeDao.QueryAll();
		return list;
	}
